			          ...
			          <div class="card-body p-4 p-md-5">
			            ...
			            <form class="px-md-2" method="post" enctype="multipart/form-data">
			              ...
			              <div class="form-outline mb-4">
			                ...
			                <input type="text" name="phone" id="form3Example1q" class="form-control" pattern="[-+0-9]{10,11}" title="Nhập Số Điện Thoại Mà Bạn Sử Dụng" />
			                
			              </div>
			              <div class="form-outline mb-4">
			              	<label class="form-label" for="form3Example1q">Mật Khẩu</label>
			                <input type="password" name="passwords" id="form3Example1q" class="form-control" pattern="[a-zA-Z0-9 ]{3,30}" title="Mật Khẩu Không Chứa Ký Tự Đặc Biệt" />
			                
			              </div>
			            
			              <button type="submit" style="margin-top: 20px;" class="btn btn-primary btn-lg mb-1">Đăng Nhập</button>
