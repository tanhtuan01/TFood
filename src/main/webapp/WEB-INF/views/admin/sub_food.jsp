		...
		<div class="row">
			<div class="col-md-2 left">
				...
				<div class="row menu">
					...
					<ul>
						...
						<a href="#!"><li class="active"><i class="fas fa-hotdog"></i>&nbsp;Món Phụ</li></a>
						<ul>
			...
			<div class="col-md-10 right">
				<div class="row">
					...
					<div class="col-md-8">
						<form class="form-outline" action="searchSubFood" method="post" style="padding:15px">
							<span>
				...
				<div class="row">
					<hr>		
					<div class="col-md-3">
						<h6 style="margin-top: 8px;">Thêm Mới Thực Đơn: Món Kèm Thêm</h6>	
					...
					<form method="post" action="${action}" enctype="multipart/form-data">
						<table class="table table-category" id="table">
							...
							<tr>
								...
								<th>
									<input type="number" name="gia" required value="${gia}">
								</th>
							</tr>
							...
							<tr>
								<th>Mô Tả</th>
								<th>
									<textarea style="padding: 5px;" name="mota" cols="87" rows="3">${moTa}</textarea>
								</th>
							</tr>
							<tr>
