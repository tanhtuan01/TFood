	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-2 left">
				...
				<div class="row menu">
					...
					<ul>
						...
						<a href="#!"><li class="active"><i class="fas fa-retweet" style="color:black"></i>&nbsp;Img-Ads</li></a>
			...
			<div class="col-md-10 right">
				<div class="row">
					<h5>Ads Hiện tại <b class="text-danger">: ${notify}</b></h5>		
					<hr>			
				</div>
				<div class="row thong-ke">
					...
					<div class="col-md-3" id="row-slide">
						...
						<div class="row giao-dich">
							<img src="<c:url value="/resources/images/${ads.img}"/>" id="avt">
						</div>
						<a class="xem" href="editAds?id=${ads.id}&content=${ads.content}&img=${ads.img}&link=${ads.link}" style="float: right;">
							Sửa
						</a>
						<a class="xoa" href="deleteAds?id=${ads.id}" style="float: left;">
							Xóa
						</a>
					</div>
					</c:forEach>
					...
					<div class="col-md-8" style="margin-bottom: 20px;">
						...
						<table class="table">
							<tr>
								<th>Nội dung</th>
								<th>
									<input value="${content}" type="text" name="content" style="width: 100%;padding: 5px;" required>
								</th>
							</tr>
							<tr>
								<th>Đường dẫn</th>
								<th>
									<input value="${link}" type="text" name="link" style="width: 100%;padding: 5px;" required placeholder="https://">
								</th>
							</tr>
							<tr>
								<th>Hình ảnh</th>
