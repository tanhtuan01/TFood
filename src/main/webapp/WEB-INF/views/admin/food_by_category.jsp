		...
		<div class="row">
			<div class="col-md-2 left">
				...
				<div class="row menu">
					...
					<ul>
						...
						<ul>
							<a href="/T-Food/admin/list-food"><li class="active"><i class="fa fa-list"></i>&nbsp;Danh sách</li></a>
						</ul>
			...
			<div class="col-md-10 right">
				<div class="row">
					...
					<div class="col-md-8">
						<form action="/T-Food/admin/searchFood" class="form-outline" method="post" style="padding:15px">
							<span>
					...
					<table class="table">
						...
						<c:forEach items="${listFoods}" var="list">
							<tr>
								...
								<td>
									<a href="deleteMainFoods?id=${list.id}" class="btn btn-primary">
