			...
			<div class="col-md-2 left">
				...
				<div class="row menu">
					...
					<ul>
						...
						<a href="#!"><li class="active"><i class="fa fa-th-list"></i>&nbsp;Danh Mục</li></a>
						...
						<a href="/T-Food/admin/subFood"><li><i class="fas fa-hotdog"></i>&nbsp;Món Phụ</li></a>						<a href=""><li><i class="fas fa-user-cog"></i>&nbsp;Thông Tin Tài Khoản</li></a>
						<ul>
			...
			<div class="col-md-10 right">
				<div class="row">
					...
					<div class="row">
						<hr>		
						<div class="col-md-2">
							<h6 style="margin-top: 8px;">Thêm Mới Danh Mục</h6>	
						...
						<div class="col-md-7 text-danger">${messages}</div>
					</div>		
					
					<form method="post" action="${action}" enctype="multipart/form-data">
						<table class="table table-category" id="table">
							<tr>
								<th>Tên Danh Mục <b style="color: red">(*)</b></th>
								<th>
							...
							<tr>
								...
								<th>
									<input type="text" name="title" value="${titleCategory}" required>
								</th>
							</tr>
							<tr>
								<th>Thứ Tự Hiển Thị </th>
								<th>
									<input type="text" name="thutuhienthi" value="${thuTuHienThi}">
								</th>
							</tr>
							<tr>
					...
					<table class="table">
						...
						<tr>
							...
							<td>
								<a href="deleteCategory?id=${list.id}" class="btn btn-primary"  id="btn-delete">
