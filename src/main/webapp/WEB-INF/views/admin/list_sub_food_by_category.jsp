...
<head>
	...
	<title>Món mua thêm - Theo danh mục</title>
		...
		<div class="row">
			<div class="col-md-2 left">
				...
				<div class="row menu">
					...
					<ul>
						...
						<ul>
							<a href="#!"><li  class="active"><i class="fa fa-list"></i>&nbsp;Danh sách</li></a>
						</ul>
			...
			<div class="col-md-10 right">
				<div class="row">
					...
					<div class="col-md-8">
						<form class="form-outline" action="/T-Food/admin/searchSubFood" method="post" style="padding:15px">
							<span>
								<input type="search" name="name" placeholder="Nhập tên món..." id="form1" class="form-control" autocomplete="off" />
				...
				<div class="row">
					<p class="text-danger" style="text-align:center;">${name}</p>
					<h6>Danh Sách &nbsp;
						<c:forEach items="${listCategories}" var="list">
							<a href="/T-Food/admin/listSubFoodByCategory/${list.id}/${list.tenDanhMuc}">${list.tenDanhMuc}<i class="fas fa-angle-down" style="margin-right: 10px"></i></a>&nbsp;
						</c:forEach>
					</h6>
				</div>
				...
				<div class="row">
					<table class="table">
						...
						<tr>
							...
							<td class="mon-gia"><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${list.gia}"/>đ</td>
							
							<td class="mon-ngay-tao">${list.thoiGianTao}</td>
							<td>
								<a href="editSubFood?id=${list.id}&gia=${list.gia}&img=${list.img}&tenmon=${list.tenMon}&mota=${list.moTa}" class="btn btn-primary">
									<i class="far fa-edit"></i>
								</a>
							</td>
							<td>
								<a href="deleteSubFood?id=${list.id}" class="btn btn-primary">
