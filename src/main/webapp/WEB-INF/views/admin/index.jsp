		...
		<div class="row">
			<div class="col-md-2 left">
				...
				<div class="row menu">
					...
					<ul>
						<a href="#!"><li class="active"><i class="fas fa-home i-active"></i>&nbsp;Home</li></a>
			...
			<div class="col-md-10 right">
				...
				<div class="row thong-ke">
					<div class="col-md-4">
						...
						<div class="row giao-dich">
							...
							<div class="col-md-5">
								<p>: ${quantityOfSuccessOrder}</p>
								<p>: ${quantityOfCancelOrder}</p>
								<p>: ${quantityOfAnotherOrder}</p>
								<p>: ${quantityOfOrder}</p>
							</div>
						</div>
						<a class="xem" href="#!" style="float: right;">
					...
					<div class="col-md-4">
						...
						<div class="row giao-dich">
							...
							<div class="col-md-5">
								<p>: <fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${revenueToday}"/>đ</p>
								<p>: <fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${revenue}"/>đ</p>
							</div>
						</div>
						<a class="xem" href="#!" style="float: right;">
							Xem chi tiết&nbsp;<i class="fas fa-angle-double-right"></i>
				...
				<div class="row danh-sach" id="danh-sach">
