				...
				<div class="col-md-10 profile">
					<div class="row">
						...
						<div class="col-md-9" style="border-left: 1px solid black;height: 200px">
							...
							<div class="row">
								<img src="<c:url value="/resources/images/${avatar}"/>" style="width: 25%;height: 160px;display: block;margin: auto;border-radius: 50px;">
								<h5 style="text-align: center;margin-top: 5px;">${userName}</h5>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-8">
									<input style="outline: none;width: 80%;text-align: left;padding: 3px;" value="${phone}" readonly>
								</div>
							</div>
							...
							<div class="row" style="margin-top: 5px;margin-bottom: 25px;">
								...
								<div class="col-md-8">
									<input style="outline: none;width: 80%;text-align: left;padding: 3px;" value="${email}" readonly>
								</div>
								<a href="edit-info">Sửa thông tin</a>
