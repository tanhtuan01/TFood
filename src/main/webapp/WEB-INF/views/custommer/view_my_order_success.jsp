			...
			<div class="row">
				...
				<div class="col-md-4 p-sign">
					<div class="row">
						...
						<div class="col-md-6">
							<a href="/T-Food/sign-out" style="color:white;text-align: right;">
								Đăng Xuất
							</a>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-3">
							<ul>
								...
								<a href="/T-Food/profile/myOrderSuccess"><li>Đơn đã nhận</li></a>
						...
						<div class="col-md-9" style="border-left: 1px solid black;">
							<h5>
								Chi tiết đơn hàng của tôi: <b>${orderCode}</b>
							</h5>
							<ul>
								<li><p>Thời gian đặt: ${date}</p></li>
								<li>
									<p>Ghi chú: 
									${note}
								</p>
							...
							<div class="col-md-12">
								<table class="table">
									...
									<tr>
										<td>${list.foodName}</td>
										<td>
											<img src="<c:url value="/resources/images/${list.img}"/>" style="height:70px;width: 200px;" alt="May this is image of product">
										</td>
										<td>${list.quantity}</td>
										<td><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${list.totalprice}"/>đ</td>
									</tr>
									</c:forEach>
								...
								<c:forEach items="${list2}" var="list">
									...
									<tr>
										<td style="text-align: right;" colspan="4">Tổng: <fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${totalPriceFood}"/>đ</td>
									</tr>
								</table>
							</div>
							...
							<ul>
								...
								<li><p>Phí giao hàng: <fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${shipPrice}"/>đ</p></li>
								<li><p>Tổng tiền: <fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${totalPrice}"/>đ</p></li>
