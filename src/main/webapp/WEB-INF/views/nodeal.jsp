				...
				<div class="col-md-4 p-sign">
					...
					<div class="row">
						...
						<div class="col-md-6 tk-users" style="${style2}">
							<a href="" style="color:white;text-align: right;">
								Tài Khoản: Users
							</a>
						</div>
					</div>
	...
	<div class="container-fluid body">
			...
			<div class="row">
				...
				<div class="col-md-8 menu1">
					<ul>
						...
						<a href="blog"><li>Bài Viết</li></a>
						<a href="about-us"><li>Giới Thiệu</li></a>
						<a href="contact-us"><li>Liên Hệ</li></a>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="row">
					...
					<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
					  <div class="carousel-inner">
					    ...
					    <div class="${slider.setClass()}">
					      ...
					      <h5 style="position: absolute;bottom: 0;margin:20px">
					      	${slider.noiDung}
					      </h5>
					    </div>
					    </c:forEach>
				...
				<div class="col-md-2 ads">
					<c:forEach items="${ads}" var="ads">
						<a href="${ads.link}">
							<img class="avt" src="<c:url value="/resources/images/${ads.img}"/>">
						</a>
					</c:forEach>				
				</div>
			</div>
					...
					<div class="row">
						...
						<div class="items">
							...
							<div class="product-price">
								<b class="new-price"><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${list.gia}"/>đ</b> &nbsp; 
								<%-- <del class="old-price"><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${list.gia}"/>đ</del>  --%>
							</div>
							<a href="${list.id}/${list.title}" class="btn btn-info view">
								<i class="far fa-eye">&nbsp;</i>
							</a>
							<a href="addToCarts/${list.id}" class="btn btn-info add-to-cart">
		...
		<div class="container">
			<c:forEach items="${cmt}" var="cmt">
				<div class="row quote">
					<div class="col-md-3">
						<img class="avt" src="<c:url value="/resources/images/${cmt.img}"/>">
					</div>
					<div class="col-md-9">
						<h5>${cmt.name}</h5>
						<p>
