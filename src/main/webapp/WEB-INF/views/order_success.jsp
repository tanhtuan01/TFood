...
<body>
	...
	<!-- Body -->
	<div class="container-fluid body" style="height: 550px;max-height: 550px;">

		<div class="container">
			<div class="row">
				<a href="" style="text-align:center;margin-top: 50px;"><i class="far fa-calendar-check" style="font-size: 300px;color: #17a2c6;"></i></a>
				<p >
					<h4 style="text-align: center;">
						Chúng tôi đã tiếp nhận đơn đặt hàng của bạn
					</h4>
				</p>
				<p style="text-align: center;">
					Hãy để ý điện thoại, chúng tôi sẽ gọi lại cho bạn bây giờ!!
				</p>
				<!-- <p style="text-align:center;">
					<a href="">Xem</a>
				</p> -->
				<p style="text-align:center;">
					<a href="/T-Food/" class="btn btn-primary">Tiếp tục mua</a>
				</p>
			</div>
		</div>
