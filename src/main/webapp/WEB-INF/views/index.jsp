		...
		<div class="container ">
			<div class="row">
				<div class="col-md-8">	<!-- fas fa-phone -->
					<a href=""><h1 class="txt-tfood2">TFOOD</h1></a>
				...
				<div class="col-md-4 p-sign">
						<p  style="${style}">
							...
							<a href="sign-up" class="sign">Đăng Ký</a>&nbsp;<b style="color: silver">|</b>&nbsp;
						</p>
	...
	<div class="container-fluid body">
			...
			<div class="row">
					...
					<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
					  ...
					  <c:forEach items="${slider}" var="slider">
					    <div class="${slider.setClass()}">
					      <img class="d-block w-100" src="<c:url value="/resources/images/slider/${slider.img}"/>">
					      <h5 style="position: absolute;bottom: 0;padding:2px;color:white;font-weight: bold;text-transform: uppercase;width:100%;background-color:#17a2c6;text-align:center;">
					      	${slider.noiDung}
					      </h5>
					    </div>
					    </c:forEach>
				...
				<div class="col-md-2 ads">
					<c:forEach items="${ads}" var="ads">
						<a href="${ads.link}">
						<img class="avt" src="<c:url value="/resources/images/${ads.img}"/>" alt="ads-img">
						</a>
					</c:forEach>
				</div>
			</div>
		...
		<div class="container product">
			...
			<div class="row ">
				<div class="col-md-10 all-product">
					<div class="row">
						...
						<div class="items" id="product-${list.id}">
							...
							<img class="product-img" src="<c:url value="/resources/images/${list.img}"/>">
							<div class="product-name">
								${list.tenMon}
							</div>
							<div class="product-price">
								<b class="new-price"><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${list.giaMoi}"/>đ</b> &nbsp; 
								<del style="${list.setStatus()}" class="old-price"><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${list.gia}"/>đ</del> 
							</div>
							<a target="_blank" href="${list.id}/${list.title}" class="btn btn-info view" style="position: absolute;bottom: 0;left: 0">
								<i class="far fa-eye">&nbsp;</i>
							</a>
							<a href="addToCarts/${list.id}" class="btn btn-info add-to-cart" style="position: absolute;bottom: 0;right: 0">
				...
				<div class="col-md-2">
					<marquee direction="up" scrollamount="3" style="height: 189vh;" behavior="alternate" >
		...
		<div class="container">
			...
			<div class="row before-last">
				...
				<div class="col-md-6">
					...
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.6676702537075!2d105.80011782424698!3d21.005954641265788!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313454b5534fb3bf%3A0x3af152649f6b709a!2zVmnhu4duIEPDtG5nIE5naOG7hyBUaMO0bmcgVGluIElUUGx1cw!5e0!3m2!1svi!2sus!4v1655978738226!5m2!1svi!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
				</div>
				<hr class="hr-footer">
			</div>
			<div class="row">
