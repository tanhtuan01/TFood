...
public class ShipperDTO {
	...
	public ShipperDTO(int id, String ten, String soDienThoai, String matKhau, double danhGia, String avatar,
	...
	public String toString() {
		return "ShipperDTO [id=" + id + ", ten=" + ten + ", soDienThoai=" + soDienThoai + ", matKhau=" + matKhau
