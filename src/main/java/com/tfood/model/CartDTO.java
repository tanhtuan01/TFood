...
public class CartDTO {
	...
	public CartDTO(int id, int user, int food, int soLuong, int gia, int tongTien, String thoiGianTao,
	...
	public String toString() {
		return "Cart [id=" + id + ", user=" + user + ", food=" + food + ", soLuong=" + soLuong + ", gia=" + gia
