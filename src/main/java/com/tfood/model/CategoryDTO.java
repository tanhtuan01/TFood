...
public class CategoryDTO {
	...
	public CategoryDTO(int id, String tenDanhMuc, String title, int thuTuHienThi, String img, String thoiGianTao,
	...
	public String toString() {
		return "CategoryDTO [id=" + id + ", tenDanhMuc=" + tenDanhMuc + ", title=" + title + ", thuTuHienThi="
