...
public class CartSub {
	...
	public CartSub(int id, int user, int food, int soLuong, int gia, int tongTien, String thoiGianTao,
	...
	public String toString() {
		return "CartSub [id=" + id + ", user=" + user + ", food=" + food + ", soLuong=" + soLuong + ", gia=" + gia
