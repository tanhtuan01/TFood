...
public class OrderDetail {
	...
	public OrderDetail(int id, int user_id, int orders_id, String name, String food_name, String phone_number,
	...
	public String toString() {
		return "OrderDetail [id=" + id + ", user_id=" + user_id + ", orders_id=" + orders_id + ", name=" + name
